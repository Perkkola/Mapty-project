...
class App {
 ...
 <div class="workout__details">
    ...
    console.log(document.querySelector(`.workout[data-id="${workout.id}"]`));
  }
  ...
  _delete = e => {
    ...
    console.log(this.#workouts.find(work => work.id === elID));
    this.#workouts.splice(
      this.#workouts.find(work => work.id === elID),
      1
    );

    this.#map.removeLayer(this.#markers.get(elID));
    this.#markers.delete(elID);
